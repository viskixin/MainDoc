...
![image-20211102184012893](..\imgs\02\Summary\Office\Excel Mobile\image-20211102184012893.png)
...
![image-20211103095226468](..\imgs\02\Summary\Office\Excel Mobile\image-20211103095226468.png)

![image-20211103095353459](..\imgs\02\Summary\Office\Excel Mobile\image-20211103095353459.png)
...
![image-20220111155006519](..\imgs\02\Summary\Office\Excel Mobile\image-20220111155006519.png)

![image-20220111155441113](..\imgs\02\Summary\Office\Excel Mobile\image-20220111155441113.png)
...
![image-20241224111039039](..\imgs\02\Summary\Windows\image-20241224111039039.png)

### 手机分组

![image-20241224111429343](..\imgs\02\Summary\Windows\image-20241224111429343.png)

### [无法创建文本文档](https://product.pconline.com.cn/itbk/software/dnyw/1524/15244157.html)

注册文件：<a href="..\document\02\Summary\exe\txtFile.reg">txtFile.reg</a>
...
-- 静态IP 配置将[BOOTPROTO]从[dhcp]改成[static]，重新设置一个固定的ip地址
   配置子网掩码位数 PREFIX=24 → 相当于 NETMASK=255.255.255.0
...
-- 静态IP 配置 → 将[method]从[auto]改成[manual]，添加 address1、dns(有多个，用逗号隔开)
[ipv4]
method=manual
address1=192.168.90.91/24,192.168.0.1
...
-- 应用更改
nmcli connection up /etc/.../ens160.nmconnection
```
