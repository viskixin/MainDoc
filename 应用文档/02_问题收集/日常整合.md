...
<a href="../docs/02/Integration/pom.xml">pom.xml</a>

## Entity创建

### 基本实体类

<a href="../docs/02/Integration/entity/BaseEntity.java">BaseEntity.java</a>

### 扩展实体类

<a href="../docs/02/Integration/entity/AuditEntity.java">AuditEntity.java</a>

### 分页查询实体类

<a href="../docs/02/Integration/entity/PageResult.java">PageResult.java</a>
...
<a href="../docs/02/Integration/dao/BaseDao.java">BaseDao.java</a>

### implements

<a href="../docs/02/Integration/dao/impl/BaseDaoImpl.java">BaseDaoImpl.java</a>
...
<a href="../docs/02/Integration/entity/info/User.java">User.java</a>

### XML元数据形式

#### 实体类

<a href="../docs/02/Integration/entity/info/Production.java">Production.java</a>

#### 实体.orm.xml

<a href="../docs/02/Integration/resources/entity/info/data-info.orm.xml">data-info.orm.xml</a>

### 数据源.xml

<a href="../docs/02/Integration/resources/META-INF/persistence-oracle.xml">persistence-oracle.xml</a>

### BaseDAOImpl继承使用

#### interface

<a href="../docs/02/Integration/dao/inter/UserInfoDao.java">UserInfoDao.java</a>

<a href="../docs/02/Integration/dao/inter/ProductInfoDao.java">ProductInfoDao.java</a>

#### implements

<a href="../docs/02/Integration/dao/impl/business/UserInfoDaoImpl.java">UserInfoDaoImpl.java</a>

<a href="../docs/02/Integration/dao/impl/business/ProductInfoDaoImpl.java">ProductInfoDaoImpl.java</a>
...
<a href="../docs/02/Integration/Zookeeper/prunmgr.exe">prunmgr.exe</a>、<a href="../docs/02/Integration/Zookeeper/prunsrv.exe">prunsrv.exe</a>、<a href="../docs/02/Integration/Zookeeper/install.bat">install.bat</a>、<a href="../docs/02/Integration/Zookeeper/zkServerStop.cmd">zkServerStop.cmd</a>
