...
# 安装参考
https://blog.csdn.net/qq_32653877/article/details/81984745
```
...
```tex
Ctrl + Shift + P → 搜索 configure display language → Enter → 选择语言 → 重启
```
...
## [【IDEA】Java工具](https://www.jetbrains.com)
...
2) 类 implements Serializable 之后，光标悬浮或选中类名，然后按 Alt+Enter+Enter 即可生成“序列化UID”
```
...
###### [编辑者、时间、描述...模板](https://blog.csdn.net/weixin_42077253/article/details/109527083)
...
#### * [Command line is too long. Shorten command line for className](https://blog.csdn.net/qq_40682764/article/details/109215368)
...
## [【Eclipse】Java工具](https://www.eclipse.org)
...
#### * [等号左边自动补齐快捷键](https://blog.csdn.net/weixin_41079550/article/details/87387971)
...
[Vue 资源](https://github.com/vuejs/vue) , [调试工具 ](https://blog.csdn.net/weixin_46048542/article/details/128117598)
